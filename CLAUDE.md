...
- Current agent release: v2.2.181. Check GitHub/main before relying on a commit hash.
...
- v2.2.181: station shutdown/restart commands use the native Windows executable with forced application closure, preventing Assetto Corsa or Content Manager from blocking power actions.
