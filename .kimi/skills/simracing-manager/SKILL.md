---
name: simracing-manager
description: Maintains and deploys the SimRacing Manager monorepo. Use when changing the dashboard, backend, Windows agent, Assetto Corsa content, race results, station fleet, menu/tablet, mods inventory, releases, or production deployment.
---
