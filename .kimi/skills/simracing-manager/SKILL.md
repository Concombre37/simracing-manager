...
- **Current version**: `2.2.56` (agent version is the source of truth; root `package.json` may lag).

### Active agent

| Path            | Role                                                                                                          | Version  | Released?              |
| --------------- | ------------------------------------------------------------------------------------------------------------- | -------- | ---------------------- |
| `apps/agent/`   | New monorepo agent, uses `@simracing/shared`, auto-provisioning + API-key auth, koffi shared-memory telemetry | `2.2.56` | Released               |
