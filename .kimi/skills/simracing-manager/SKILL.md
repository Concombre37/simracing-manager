...
- **Version de référence**: l'agent (`apps/agent/package.json`) — `2.2.172`. Les autres workspaces suivent désormais la même version de release.
